 ...
 * @author Manuel
 */
@WebServlet(name = "ServletPDFUsuarioAnalista", urlPatterns = {"/ServletPDFUsuarioAnalista"})
public class ServletPDFUsuarioAnalista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String usr = "root";
                String pwd = "";
                String sql="select * from usuario where id_perfil='2'";
