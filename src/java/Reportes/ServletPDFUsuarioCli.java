 ...
 * @author Manuel
 */
@WebServlet(name = "ServletPDFUsuarioCli", urlPatterns = {"/ServletPDFUsuarioCli"})
public class ServletPDFUsuarioCli extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String usr = "root";
                String pwd = "";
                String sql="select * from usuario where id_perfil='4'";
