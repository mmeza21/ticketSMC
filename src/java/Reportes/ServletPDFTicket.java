 ...
 * @author Manuel
 */
@WebServlet(name = "ServletPDFTicket", urlPatterns = {"/ServletPDFTicket"})
public class ServletPDFTicket extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Image imagenes = Image.getInstance("C:\\Users\\Jhony\\Desktop\\Final\\ProyectoFinal\\ProTicketUPN4.0\\web\\imagenes\\tickets.jpg");
              ...
              Paragraph par1 = new Paragraph();
                ...
                par1.add(new Phrase("Reporte de Tickets Registrados en Sistema",fonttitulo));
                ...
                PdfPCell celda2 = new PdfPCell(new Paragraph("# Proyecto",FontFactory.getFont("Tahoma", 11, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda3 = new PdfPCell(new Paragraph("Nombre Ticket",FontFactory.getFont("Tahoma", 11, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda4 = new PdfPCell(new Paragraph("Asunto",FontFactory.getFont("Tahoma", 11, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda5 = new PdfPCell(new Paragraph("Prioridad",FontFactory.getFont("Tahoma", 11, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda6 = new PdfPCell(new Paragraph("Fecha Creacion",FontFactory.getFont("Tahoma", 11, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda7 = new PdfPCell(new Paragraph("Tipo",FontFactory.getFont("Tahoma", 11, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda8 = new PdfPCell(new Paragraph("Remitente",FontFactory.getFont("Tahoma", 11, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda9 = new PdfPCell(new Paragraph("Atendido",FontFactory.getFont("Tahoma", 11, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda10 = new PdfPCell(new Paragraph("Estado",FontFactory.getFont("Tahoma", 11, Font.BOLD, BaseColor.BLACK)));
