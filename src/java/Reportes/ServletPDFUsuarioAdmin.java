 ...
 * @author Manuel
 */
@WebServlet(name = "ServletPDFUsuarioAdmin", urlPatterns = {"/ServletPDFUsuarioAdmin"})
public class ServletPDFUsuarioAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String usr = "root";
                String pwd = "";
                String sql="select * from usuario where id_perfil='1'";
