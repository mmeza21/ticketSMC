...
<html>
    <head>
       ...
       <!-- Boostrap-->
        ...
        <!--fin-->  
        <title>Listado de Tickets Programacion</title>
    </head>
    <body style="margin-top: 30px">      
        <%
            ...
            rs = smt.executeQuery("select * from tickets where tipo='programacion'");
            //Creamo la Tabla:     
        %>
        
        <div class="container-fluid">
            <h1 class="text-center">TICKETS DE TIPO PROGRAMACIÓN PROTICKET CONSULTING</h1>        
                    ...
                    <tbody id="tbodys">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="EditarTicketPro.jsp?id=<%= rs.getInt("id_ticket")%>"><img src="icon/Edit.png" height="30px" width="30px"></a>
                                <a href="DeleteTicketPro.jsp?id=<%= rs.getInt("id_ticket")%>"><img src="icon/Delete.png" height="30px" width="30px" onclick="return confirm('¿Estas seguro?');"></a>
                            </td>
                        </tr>
                        <%}%>
                </table>
